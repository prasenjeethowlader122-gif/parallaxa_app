...
export const GetFollowersQueryParams = zod.object({
  ...
  limit: zod.coerce
    .number()
    .min(1)
    .max(getFollowersQueryLimitMax)
    .default(getFollowersQueryLimitDefault),
});
...
export const GetFollowingQueryParams = zod.object({
  ...
  limit: zod.coerce
    .number()
    .min(1)
    .max(getFollowingQueryLimitMax)
    .default(getFollowingQueryLimitDefault),
});
...
export const getCommentsQueryLimitMax = 100;
...
export const GetCommentsQueryParams = zod.object({
  ...
  limit: zod.coerce
    .number()
    .min(1)
    .max(getCommentsQueryLimitMax)
    .default(getCommentsQueryLimitDefault),
});
...
export const GetExplorePostsQueryParams = zod.object({
  ...
  limit: zod.coerce
    .number()
    .min(1)
    .max(getExplorePostsQueryLimitMax)
    .default(getExplorePostsQueryLimitDefault),
});
...
export const GetNotificationsQueryParams = zod.object({
  ...
  limit: zod.coerce
    ...
    .default(getNotificationsQueryLimitDefault),
});
...
export const GetSavedPostsQueryParams = zod.object({
  ...
  limit: zod.coerce
    .number()
    .min(1)
    .max(getSavedPostsQueryLimitMax)
    .default(getSavedPostsQueryLimitDefault),
});
